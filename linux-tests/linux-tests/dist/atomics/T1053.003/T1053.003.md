...
- [Atomic Test #5 - Cron Service Manipulation](#atomic-test-5---cron-service-manipulation)
...
## Atomic Test #5 - Cron Service Manipulation
Detects manipulation of the cron service using systemctl and bash commands
